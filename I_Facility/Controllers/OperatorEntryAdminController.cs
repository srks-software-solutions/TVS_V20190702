...
namespace I_Facility.Controllers
{
    public class OperatorEntryAdminController : Controller
    {
        ...
        //[HttpPost]
        //public ActionResult EntryWindowAdmin(UnitWorksCCS.Models.tabtblworkorderentry WOE, int machineId)
        //{
        //    int MachineID = machineId;
        ...
        //    //UnitWorksCCS.Models.tabtbldaytiming StartTime = _UWcontext.tabtbldaytimings.Where(m => m.IsDeleted == 0).FirstOrDefault();
        ...
        //    //UnitWorksCCS.Models.tabtblworkorderentry WOEntry = new UnitWorksCCS.Models.tabtblworkorderentry();
