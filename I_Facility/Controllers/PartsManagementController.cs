...
//            ViewBag.Unit = new SelectList(db.tblunits.Where(p => p.IsDeleted == 0), "U_ID", "Unit");
//            // ViewData["txtShow"] = "";
//            //ViewBag.text = "";
//            return View(PM);
//        }
...
//                //item.UnitDescInMin = tblmp.MasterParts.UnitDescInMin;
//                db.SaveChanges();
//            }
//            ViewBag.Unit = new SelectList(db.tblunits.Where(p => p.IsDeleted == 0), "U_ID", "Unit",tblmp.MasterParts.UnitDescInSec);
//            return RedirectToAction("Index");
//        }
...
//                                            MasterStdPWTData.UnitDescInMin = Convert.ToInt32(unitId);
//                                        }
//                                        else //Default Unit
//                                        {
//                                            MasterStdPWTData.UnitDescInMin = 1;
//                                        }
//                                    }
//                                    catch
//                                    {
...
//                            {
//                                int? unitId = db.tblunits.Where(m => m.Unit == unitDesc).Select(m => m.U_ID).FirstOrDefault();
//                                tblmp.UnitDescInSec = Convert.ToInt32(unitId);
//                            }
//                            else //Default Unit
//                            {
//                                tblmp.UnitDescInSec = 1;
//                            }
//                        }
//                        catch
//                        {
...
//                                        {
//                                            int? unitId = db.tblunits.Where(m => m.Unit == unitDesc).Select(m => m.U_ID).FirstOrDefault();
//                                            tblmp.UnitDescInMin = Convert.ToInt32(unitId);
//                                        }
//                                        else //Default Unit
//                                        {
//                                            tblmp.UnitDescInMin = 1;
//                                        }
//                                    }
//                                    catch
//                                    {
...
//            ViewBag.id = Id;
//            i_facilityEntities1 db = new i_facilityEntities1();
//            var Data = db.tblparts.Where(m => m.IsDeleted == 0 && m.PartID == Id).Select(m => new { Pid = m.PartID, partname = m.FGCode, Operationum = m.OperationNo, StdMinorLoss = m.StdMinorLoss, IdealCycleTime = m.IdealCycleTime, UnitDesc = m.UnitDescInMin, pid = Id });
