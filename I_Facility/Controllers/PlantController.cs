...
namespace I_Facility.Controllers
{
    public class PlantController : Controller
    {
		...
		tblp.Plant.CreatedBy = ViewBag.roleid;
        ...
        public ActionResult Edit(PlantModel tblmc)
        {
            ...
            using (i_facilityEntities1 db = new i_facilityEntities1())
            {
                ...
                if (doesThisPlantExist.Count == 0)
                {
                    ...
                    Plant.PlantArea = tblmc.Plant.PlantArea;
                   // Plant.ModifiedBy = 1;
		 Plant.ModifiedBy = ViewBag.roleid;
        ...
        {
            var Data = db.tblplants.Where(m => m.PlantID == Id).Select(m => new { PlantName = m.PlantName, PlantDes = m.PlantDesc, PlantDisplay = m.PlantDisplayName, plantarea = m.PlantArea });
        ...
        public ActionResult Delete(int id)
        {
            ...
            {
                shoprow.IsDeleted = 1;
                db.Entry(shoprow).State = EntityState.Modified;
                db.SaveChanges();
