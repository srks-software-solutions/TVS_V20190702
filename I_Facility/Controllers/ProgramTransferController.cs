...
namespace I_Facility.Controllers
{
    public class ProgramTransferController : Controller
    {
            ...
            if (Request.Files["file"].ContentLength > 0)
            {
                ...
                if (retString == "Success")
                {
                    ...
                    if (pthData != null)
                    {
                        ...
                        db.Entry(pthData).State = EntityState.Modified;
                        db.SaveChanges();
        ...
        {
            string retValue = "";
            using (i_facilityEntities1 dbpupload = new i_facilityEntities1())
            {
                ...
                if (RetStatusData != null && RetStatusData.IsCompleted == 0)
                {
                    ...
                    if (int.TryParse(Convert.ToString(RetStatusData.ReturnStatus), out retStatusInt))
                    {
                        ...
                        dbpupload.Entry(RetStatusData).State = EntityState.Modified;
    ...
    public class DownloadNCProg
    {
        ...
        public string UploadCNCProgram(int pthID, out int retValueInt)
        {
            ...
            try
            {
                ...
                using (i_facilityEntities1 redb = new i_facilityEntities1())
                {
                    ...
                    if (RecordToUpdate != null)
                    {
                        ...
                        redb.Entry(RecordToUpdate).State = EntityState.Modified;
                        redb.SaveChanges();
