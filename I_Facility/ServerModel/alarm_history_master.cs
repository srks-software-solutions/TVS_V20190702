...
namespace I_Facility.ServerModel
{
    ...
    public partial class alarm_history_master
    {
        ...
        public Nullable<int> AlarmMonth { get; set; }
        public Nullable<int> AlarmYear { get; set; }
        public Nullable<int> AlarmWeekNumber { get; set; }
        public Nullable<int> AlarmQuarter { get; set; }
    }
}
