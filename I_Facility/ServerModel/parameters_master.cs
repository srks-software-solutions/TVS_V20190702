...
namespace I_Facility.ServerModel
{
    ...
    public partial class parameters_master
    {
        ...
        public Nullable<int> ParameterMonth { get; set; }
        public Nullable<int> ParameterYear { get; set; }
        public Nullable<int> ParameterWeekNumber { get; set; }
        public Nullable<int> ParameterQuarter { get; set; }
