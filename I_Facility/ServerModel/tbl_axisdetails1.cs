...
namespace I_Facility.ServerModel
{
    ...
    public partial class tbl_axisdetails1
    {
        ...
        public Nullable<int> Axisdet1Month { get; set; }
        public Nullable<int> Axisdet1Year { get; set; }
        public Nullable<int> Axisdet1WeekNumber { get; set; }
        public Nullable<int> Axisdet1Quarter { get; set; }
