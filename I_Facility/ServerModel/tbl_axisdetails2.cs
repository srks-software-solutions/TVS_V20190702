...
namespace I_Facility.ServerModel
{
    ...
    public partial class tbl_axisdetails2
    {
        ...
        public Nullable<int> Axisdet2Month { get; set; }
        public Nullable<int> Axisdet2Year { get; set; }
        public Nullable<int> Axisdet2WeekNumber { get; set; }
        public Nullable<int> Axisdet2Quarter { get; set; }
        public Nullable<System.DateTime> CorrectedDate { get; set; }
        public Nullable<int> SpindleTemperature { get; set; }
